...
> 最終更新: 2026-05-23（戦闘背景画像システム実装完了）
...
defenseFlow.phase:
  'adv'            → ADVオーバーレイ（MAP背景透過）: 防衛する/放棄する
  'abandon_confirm'→ 確認choice: はい/いいえ
...
4. ~~**戦闘背景画像システム**~~ → 完了（2026-05-23、エディタ登録・自動採番・bases.json battleBgId・BattleScene動的背景）※動作確認要
